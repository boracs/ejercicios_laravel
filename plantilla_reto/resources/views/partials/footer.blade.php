        ...
        <div class="container py-4">
            <div class="row gy-4 gx-5">
                <div class="col-lg-4 col-md-6">
                    ...
                    <p class="small  text-white">Plantilla creada con muchisimo cariño para Nahikari Otegui</p>
                    <p class="small  text-white mb-0">&copy; Copyrights. All rights reserved. <a class=" text-white" href="#">Borja Bolado</a></p>
                </div>
